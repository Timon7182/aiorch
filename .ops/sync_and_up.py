...
FILES_TO_SYNC = [
    ...
    "apps/web-server/server/services/claude_token_service.py",
    ...
    "apps/frontend-web/src/components/insights/ChatAttachmentBar.tsx",
    "apps/frontend-web/src/shared/types/insights.ts",
    ...
    "apps/backend/core/multi_repo.py",
