...
export const webAPI: API & { _isWebMode: boolean } = {
  ...
  sendInsightsMessage: (projectId: string, message: string, attachments?: ChatAttachment[], modelConfig?: InsightsModelConfig, branch?: string, repo?: string) => {
    post(`/projects/${projectId}/insights/message`, { message, attachments, modelConfig, branch, repo });
  },
